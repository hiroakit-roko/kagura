...
const LIST := [
	...
	},
	{
		...
		"cost": "雷気が指に居座り、詠唱の珠が手に戻りにくい（珠の吸引範囲 -30%）", "flavor": "雷の日に外へ出ると、必ず髪が逆立つ", "mark": "契約の刻印：指先に残る火花",
...
const BOONS := [
	...
	{"id": "tsuki_u8", "kami": "tsuki", "tier": Cfg.Rar.EPIC, "name": "月の盾", "desc": "刃が触れた敵弾を消す。刃の大きさ +{v}", "base": 15.0, "fmt": "pct", "maxlv": 2},
