...
const LIST := [
	...
	},
	{
		...
		"role": "近接周回・時限爆発・範囲",
		"weapon": "月輪", "weapon_desc": "自機の周りを回る三日月の刃。触れた敵弾をすべて消す盾でもある。触れた敵に宿命を刻み、少し遅れて範囲爆発",
	...
	},
	{
		...
		"status": "酩酊", "status_desc": "酩酊は重なるごとに毎秒のダメージが増え、動きも弾も鈍る（緑の泡）",
...
const BOONS := [
	...
	{"id": "susa_u7", "kami": "susa", "tier": Cfg.Rar.EPIC, "name": "潮騒", "desc": "大波が触れた敵弾を {v} の確率で消す", "base": 32.0, "fmt": "pct", "maxlv": 3},
	...
	{"id": "suku_u8", "kami": "suku", "tier": Cfg.Rar.COMMON, "name": "酔いどれ狩り", "desc": "酩酊した敵への与ダメージ +{v}", "base": 20.0, "fmt": "pct", "maxlv": 3},
	{"id": "suku_u3", "kami": "suku", "tier": Cfg.Rar.RARE, "name": "強い酒", "desc": "酩酊のダメージ +{v}", "base": 40.0, "fmt": "pct", "maxlv": 4},
	{"id": "suku_u5", "kami": "suku", "tier": Cfg.Rar.RARE, "name": "薬師の加護", "desc": "毎秒 HP が {v} 回復する", "base": 1.0, "fmt": "x", "maxlv": 4},
	{"id": "suku_u9", "kami": "suku", "tier": Cfg.Rar.RARE, "name": "百薬の長", "desc": "酩酊した敵を倒すと {v} の確率で酒気の霧が残る", "base": 40.0, "fmt": "pct", "maxlv": 3},
